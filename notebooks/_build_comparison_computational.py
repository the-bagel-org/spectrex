"""Build comparison_computational.ipynb programmatically."""
...
cells.append(md("## Instrument Setup"))
...
cells.append(md("### Measured Memory vs K"))
...
cells.append(md("### Runtime Summary Table"))
...
cells.append(md(
    ...
    f"Fixed problem: K=5 sources, same `IMAGE_SHAPE=(500,20)` scene.\n\n"
...
cells.append(md("### LSQR Convergence (checkpoint every 10 iterations)"))
...
cells.append(md("### FISTA Convergence (per-iteration residual)"))
...
cells.append(md("### Residual Norm vs Wall-Clock Time"))
...
path = Path(__file__).parent / 'comparison_computational.ipynb'
